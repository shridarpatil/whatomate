...
<template>
  <div class="flex flex-col h-full bg-[#0a0a0b] light:bg-gray-50/50">
    <PageHeader :title="$t('settings.title')" :subtitle="$t('settings.subtitle')" :icon="Settings" icon-gradient="bg-gradient-to-br from-primary to-primary-foreground/20 shadow-primary/20" />
            ...
            <div class="rounded-xl border border-white/[0.08] bg-white/[0.02] light:bg-white light:border-gray-200">
              ...
              <div class="p-6 pt-3 space-y-4">
                <div class="space-y-2">
                  ...
                  <Input id="org_name" v-model="generalSettings.organization_name" :placeholder="$t('settings.organizationPlaceholder')" class="bg-muted/10 border-white/[0.05]" />
                </div>
                <div class="grid grid-cols-2 gap-4">
                  <div class="space-y-2">
                    ...
                    <Select v-model="generalSettings.default_timezone">
                      <SelectTrigger class="bg-muted/10 border-white/[0.05] text-white/70 light:bg-white light:border-gray-200 light:text-gray-700">
                ...
                <div class="space-y-2">
                  <Label class="text-white/70 light:text-gray-700"><Globe class="h-4 w-4 inline mr-1" />{{ $t('settings.language') }}</Label>
                ...
                <div class="flex justify-end pt-4">
                  <Button variant="outline" size="sm" class="bg-primary/5 border-primary/20 text-primary hover:bg-primary/10 transition-all" @click="saveGeneralSettings" :disabled="isSubmitting">
          ...
          <TabsContent value="notifications">
            <div class="rounded-xl border border-white/[0.08] bg-white/[0.02] light:bg-white light:border-gray-200">
              ...
              <div class="p-6 pt-3 space-y-4">
                ...
                <div class="flex justify-end pt-4">
                  <Button variant="outline" size="sm" class="bg-primary/5 border-primary/20 text-primary hover:bg-primary/10 transition-all" @click="saveNotificationSettings" :disabled="isSubmitting">
                    <Loader2 v-if="isSubmitting" class="mr-2 h-4 w-4 animate-spin" />
                    {{ $t('settings.save') }}
                  </Button>
                </div>
          ...
          <TabsContent value="calling">
             <div class="rounded-xl border border-white/[0.08] bg-white/[0.02] light:bg-white light:border-gray-200">
               ...
               <div class="p-6 pt-3 space-y-4">
                 ...
                 <div class="flex justify-end pt-4">
                   <Button variant="outline" size="sm" class="bg-primary/5 border-primary/20 text-primary hover:bg-primary/10 transition-all" @click="saveCallingSettings" :disabled="isSubmitting">
                     <Loader2 v-if="isSubmitting" class="mr-2 h-4 w-4 animate-spin" />
                     {{ $t('settings.save') }}
                   </Button>
                 </div>
