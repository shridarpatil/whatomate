...
- Node.js 20+ — only needed to build the frontend. CI builds it on Node 20; Vite 7 requires 20.19+ or 22.12+.
- PostgreSQL — CI tests against 15/16, the Docker Compose file ships 17
- Redis 7 (Redis 6+ works; `username` requires 6+ ACLs)
