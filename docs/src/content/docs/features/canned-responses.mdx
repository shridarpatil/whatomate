...
| **Flow** | Launches a WhatsApp Flow (see [WhatsApp Flows](/whatomate/features/whatsapp-flows/)) when tapped. | 1 per message. Exclusive — can't be combined with any other button type. |
...
See the [Calling docs](/whatomate/features/calling/) for the broader incoming-call
